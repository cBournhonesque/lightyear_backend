...
pub async fn location_beacon_list(configuration: &configuration::Configuration, ) -> Result<crate::models::LocationBeaconList, Error<LocationBeaconListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/v1/locations/beacons", configuration.base_path);
...
pub async fn locations_get(configuration: &configuration::Configuration, app: Option<&str>, version: Option<&str>, _type: Option<&str>, tags: Option<&str>) -> Result<crate::models::Locations, Error<LocationsGetError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/v1/locations", configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
