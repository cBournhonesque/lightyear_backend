...
pub struct FleetPoliciesPostPayload {
    /// Name of the Policy
    #[serde(rename = "name")]
    pub name: String,
...
impl FleetPoliciesPostPayload {
    pub fn new(name: String, enabled: bool, _type: Type, minimum: i32, maximum: i32, threshold: f32, data: serde_json::Value) -> FleetPoliciesPostPayload {
