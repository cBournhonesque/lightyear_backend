...
pub struct RelaySessionUserBaseResponse {
    /// The session ID
    ...
    /// List Session Users
    #[serde(rename = "session_user", skip_serializing_if = "Option::is_none")]
    pub session_user: Option<Box<crate::models::RelaySessionUserResponse>>,
